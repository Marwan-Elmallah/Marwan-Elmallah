...
### 🏥 EvoSmart Medical Center Management SaaS
> Full patient lifecycle REST API — scheduling, billing, medical history & real-time notifications

- 🔐 **Three-tier RBAC**: `admin` / `reception` / `doctor` with JWT auth and per-role middleware enforcement
- ⚡ **Server-Sent Events (SSE)** for instant clinical workflow coordination without WebSocket overhead
- 🛡️ Centralized audit trail middleware — full CRUD & auth event logging for compliance and forensics
- 🏗️ Cloudflare WAF (OWASP Top 10) · Docker containerized · Zero-downtime DNS migration with custom tenant domains
- 📦 Multi-tenant architecture supporting isolated clinic workspaces from a single deployment
...
### 💰 EvoSmart Finance Management SaaS
> Double-entry accounting engine with payroll, asset lifecycle & multi-tenant billing

- 💳 **Idempotent payment APIs** — prevents duplicate transactions, full reconciliation trails
- 👥 Complete employee lifecycle: salary calculations, payslips, overtime tracking, deductions
- 🏢 Multi-tenant RBAC: `admin` / `accountant` / `sales` with scoped data isolation per tenant
- 🚀 Delivered **MVP with 15+ REST endpoints in 2 weeks**, enabling immediate frontend integration

[![Live Demo](https://img.shields.io/badge/Live_Demo-C9A84C?style=flat-square&logo=vercel&logoColor=black)](https://finance.evosmart.co)
...
- ⚙️ **Platform Administration** — server setup on Laragon/Herd, config tuning, plugin lifecycle & user management
- 🎨 **Theme Development** — custom Boost-based themes aligned with institutional branding
- 🔌 **Plugin Development** — custom PHP plugins extending core LMS functionality
- 🔗 **API & SSO Integration** — REST API bridge and Single Sign-On workflows for seamless third-party auth

---

### 🏥 Fatema Center Clinical Backend
> Three-tier RBAC clinical backend with comprehensive medical history schema and session lifecycle

- 📋 **15+ condition flags**: allergies, diabetes, hypertension, chronic conditions — with free-text diagnostics
- 🔄 **Session lifecycle**: `scheduled → in-progress → completed` with doctor assignment and handoff
- 📁 Multer-based image/document uploads (signatures, scans) · Heroku-ready deployment

---

### 🤖 n8n Telegram Automation
> Bank transaction tracking bot with SMS parsing, smart account inference, and Supabase pipeline

- 📩 Parses incoming SMS from Egyptian banks into structured transactions via Telegram
- 🧠 Smart account inference engine identifies source account from message patterns
- 🗄️ Supabase backend for persistent transaction storage and query
...
[![Demo](https://img.shields.io/badge/Live_Demo-C9A84C?style=flat-square&logo=vercel&logoColor=black)](https://marwan-elmallah.github.io/Chat-Group-Front)

---

### 📊 Sales Workflow Web App — Bayanat Smart Systems
> Internal lead tracking, progress monitoring & automated reporting tool

- 📈 Excel/VBA automation cutting manual reporting time by **40%**
- 👤 Access controls and user roles for the sales team
- 🔗 Integrated with CRM customer workflows

[![Repo](https://img.shields.io/badge/View_Repo-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Marwan-Elmallah/Opportunity-Back)

---

### 🧩 Portfolio Builder Backend
> REST API powering a full-stack developer portfolio platform

- 🔐 JWT authentication with Joi schema validation
- 🗄️ Supabase for database and file storage
- 📦 Clean REST API with full CRUD

[![Repo](https://img.shields.io/badge/View_Repo-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Marwan-Elmallah/Portfolio_Builder)
[![Demo](https://img.shields.io/badge/Live_Demo-C9A84C?style=flat-square&logo=vercel&logoColor=black)](https://marwan-elmallah.github.io/Own_Portfolio)
...
|-----------|--------|------|
| B.Sc. Electronics & Communications Engineering | Alexandria Institute of Engineering & Technology (AIET) | 2020 |
| Vehicle Tracking System Accreditation | UAE General Regulatory Authority (GRA) | Active |
| CCNA-Level Networking | Cisco curriculum | — |
...
*"Engineering is not just writing code — it's understanding systems end-to-end, from the fiber-optic cable to the API response."*

![Profile Views](https://komarev.com/ghpvc/?username=Marwan-Elmallah&color=C9A84C&style=flat-square&label=Profile+Views)
